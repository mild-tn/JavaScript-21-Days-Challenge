(() => {
  ...
  function moveSnowBalls(snowBall, canvas) {
  ...
  function run() {
    const { canvas, canvasContext, numberOfShowBalls } = setup();
    const snowBalls = createSnowBalls(canvas, numberOfShowBalls);
